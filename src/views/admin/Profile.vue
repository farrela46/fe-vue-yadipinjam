...
export default {
  ...
  methods: {
    ...
    async updateUser() {
      try {
        const response = await axios.put(`${BASE_URL}/auth/admin/update`, this.users, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem('access_token')
          }
        });
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control" type="text" v-model="users.balance" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label">Trust Point</label>
                  <input class="form-control" type="text" v-model="users.trustPoint"  />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label">Status</label>
                  <input class="form-control" type="text" v-model="users.status"  />
                </div>
