...
<template>
  <div class="py-4 container-fluid">
    <div class="row mt-3">
      <router-link :to="'/products/' + item.slug" class="col-md-3 mt-2 mb-2 col-6" v-for="item in products" :key="item.id">
      <div class="product-single-card shadow">
        <div class="product-top-area">
          <div class="product-img">
            <div class="first-view">
              <img alt="Book Image" class="img-fluid">
            </div>
        ...
        <div class="product-info">
          <h6 class="text-muted" style="font-size: 15px"><a href="#">{{ item.ISBN }}</a></h6>
          <h6 class="text-uppercase" style="font-size: 20px;"><a>{{ item.title }}</a></h6>
